      ...
      <div class="container">
        <div class="row g-5">
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h5 class="mb-3">
                <a href="<?php echo base_url().'visitor/visimisi'?>" class="button-green">Visi Misi</a>
            </h5>
            <h5 class="mb-3">
                <a href="<?php echo base_url().'visitor/sejarah'?>" class="button-green">Sejarah</a>
            </h5>
            <h5 class="mb-3">
                <a href="<?php echo base_url().'visitor/relawan'?>" class="button-green">Relawan</a>
            </h5>
            <h5 class="mb-3">
                <a href="<?php echo base_url().'visitor/kontak'?>" class="button-green">Hubungi Kami</a>
            </h5>
          </div>
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="row g-4">
              <div class="col-12">
                <a
                  class="animal-item"
                  href="<?php echo base_url().'visitor/komodo'?>"
                >
              ...
              <div class="col-12">
                <a
                  class="animal-item"
                  href="<?php echo base_url().'visitor/bacusa'?>"
                >
                  <div class="position-relative">
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="row g-4">
              <div class="col-12">
                <a
                  class="animal-item"
                  href="<?php echo base_url().'visitor/orangutan'?>"
                >
                  <div class="position-relative">
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="row g-4">
              <div class="col-12">
                <a
                  class="animal-item"
                  href="<?php echo base_url().'visitor/harimau'?>"
                >
                  <div class="position-relative">
              ...
              <div class="col-12">
                <a
                  class="animal-item"
                  href="<?php echo base_url().'visitor/gajah'?>"
                >
                  <div class="position-relative">
